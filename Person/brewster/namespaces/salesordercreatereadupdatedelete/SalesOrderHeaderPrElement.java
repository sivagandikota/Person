...
/**
 * Sales Order Header Pricing Element API<p></p>
 * 
 */
@Builder
@Data
...
public class SalesOrderHeaderPrElement
    extends VdmEntity<SalesOrderHeaderPrElement>
{
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementSelectable ALL_FIELDS = new SalesOrderHeaderPrElementSelectable() {
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> SALES_ORDER = new SalesOrderHeaderPrElementField<String>("SalesOrder");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRICING_PROCEDURE_STEP = new SalesOrderHeaderPrElementField<String>("PricingProcedureStep");
    /**
     * (Key Field) Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRICING_PROCEDURE_COUNTER = new SalesOrderHeaderPrElementField<String>("PricingProcedureCounter");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_TYPE = new SalesOrderHeaderPrElementField<String>("ConditionType");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRICING_DATE_TIME = new SalesOrderHeaderPrElementField<String>("PricingDateTime");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_CALCULATION_TYPE = new SalesOrderHeaderPrElementField<String>("ConditionCalculationType");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CONDITION_BASE_VALUE = new SalesOrderHeaderPrElementField<BigDecimal>("ConditionBaseValue");
    /**
     * Constraints: Not nullable, Precision: 24, Scale: 9
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CONDITION_RATE_VALUE = new SalesOrderHeaderPrElementField<BigDecimal>("ConditionRateValue");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_CURRENCY = new SalesOrderHeaderPrElementField<String>("ConditionCurrency");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CONDITION_QUANTITY = new SalesOrderHeaderPrElementField<BigDecimal>("ConditionQuantity");
    /**
     * Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_QUANTITY_UNIT = new SalesOrderHeaderPrElementField<String>("ConditionQuantityUnit");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_CATEGORY = new SalesOrderHeaderPrElementField<String>("ConditionCategory");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Boolean> CONDITION_IS_FOR_STATISTICS = new SalesOrderHeaderPrElementField<Boolean>("ConditionIsForStatistics");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRICING_SCALE_TYPE = new SalesOrderHeaderPrElementField<String>("PricingScaleType");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_ORIGIN = new SalesOrderHeaderPrElementField<String>("ConditionOrigin");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> IS_GROUP_CONDITION = new SalesOrderHeaderPrElementField<String>("IsGroupCondition");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_RECORD = new SalesOrderHeaderPrElementField<String>("ConditionRecord");
    /**
     * Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_SEQUENTIAL_NUMBER = new SalesOrderHeaderPrElementField<String>("ConditionSequentialNumber");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> TAX_CODE = new SalesOrderHeaderPrElementField<String>("TaxCode");
    /**
     * Constraints: Not nullable, Maximum length: 2
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> WITHHOLDING_TAX_CODE = new SalesOrderHeaderPrElementField<String>("WithholdingTaxCode");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CNDN_ROUNDING_OFF_DIFF_AMOUNT = new SalesOrderHeaderPrElementField<BigDecimal>("CndnRoundingOffDiffAmount");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CONDITION_AMOUNT = new SalesOrderHeaderPrElementField<BigDecimal>("ConditionAmount");
    /**
     * Constraints: Not nullable, Maximum length: 5
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> TRANSACTION_CURRENCY = new SalesOrderHeaderPrElementField<String>("TransactionCurrency");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_CONTROL = new SalesOrderHeaderPrElementField<String>("ConditionControl");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_INACTIVE_REASON = new SalesOrderHeaderPrElementField<String>("ConditionInactiveReason");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_CLASS = new SalesOrderHeaderPrElementField<String>("ConditionClass");
    /**
     * Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRCG_PROCEDURE_COUNTER_FOR_HEADER = new SalesOrderHeaderPrElementField<String>("PrcgProcedureCounterForHeader");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Double> FACTOR_FOR_CONDITION_BASIS_VALUE = new SalesOrderHeaderPrElementField<Double>("FactorForConditionBasisValue");
    /**
     * Constraints: Not nullable, Maximum length: 1
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> STRUCTURE_CONDITION = new SalesOrderHeaderPrElementField<String>("StructureCondition");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Double> PERIOD_FACTOR_FOR_CNDN_BASIS_VALUE = new SalesOrderHeaderPrElementField<Double>("PeriodFactorForCndnBasisValue");
    /**
     * Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> PRICING_SCALE_BASIS = new SalesOrderHeaderPrElementField<String>("PricingScaleBasis");
    /**
     * Constraints: Not nullable, Precision: 24, Scale: 9
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<BigDecimal> CONDITION_SCALE_BASIS_VALUE = new SalesOrderHeaderPrElementField<BigDecimal>("ConditionScaleBasisValue");
    /**
     * Constraints: Not nullable, Maximum length: 3
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_SCALE_BASIS_UNIT = new SalesOrderHeaderPrElementField<String>("ConditionScaleBasisUnit");
    /**
     * Constraints: Not nullable, Maximum length: 5
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> CONDITION_SCALE_BASIS_CURRENCY = new SalesOrderHeaderPrElementField<String>("ConditionScaleBasisCurrency");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Boolean> CNDN_IS_RELEVANT_FOR_INTCO_BILLING = new SalesOrderHeaderPrElementField<Boolean>("CndnIsRelevantForIntcoBilling");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Boolean> CONDITION_IS_MANUALLY_CHANGED = new SalesOrderHeaderPrElementField<Boolean>("ConditionIsManuallyChanged");
    /**
     * Constraints: none
     * 
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<Boolean> CONDITION_IS_FOR_CONFIGURATION = new SalesOrderHeaderPrElementField<Boolean>("ConditionIsForConfiguration");
    /**
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementField<String> VARIANT_CONDITION = new SalesOrderHeaderPrElementField<String>("VariantCondition");
    /**
    ...
    /**
     * Navigation property <b>to_SalesOrder</b> for <b>SalesOrderHeaderPrElement</b> to single <b>SalesOrder</b>.
     * 
     */
     ...
     * 
     */
    public final static SalesOrderHeaderPrElementLink<SalesOrder> TO_SALES_ORDER = new SalesOrderHeaderPrElementLink<SalesOrder>("to_SalesOrder");
     ...
     */
    @Override
    public Class<SalesOrderHeaderPrElement> getType() {
    ...
    protected String getEntityCollection() {
        return "A_SalesOrderHeaderPrElement";
    }
     ...
     */
    public static<T >SalesOrderHeaderPrElementField<T> field(final String fieldName, final Class<T> fieldType) {
        return new SalesOrderHeaderPrElementField<T>(fieldName);
    }
     ...
     * <p>
     * If the navigation property <b>to_SalesOrder</b> of a queried <b>SalesOrderHeaderPrElement</b> is operated lazily, an <b>ODataException</b> can be thrown in case of an OData query error.
     * <p>
     ...
     * Retrieval of associated <b>SalesOrder</b> entity (one to one).
     * <p>
     * If the navigation property <b>to_SalesOrder</b> for an entity <b>SalesOrderHeaderPrElement</b> has not been resolved yet, this method will <b>not query</b> further information. Instead its <b>Optional</b> result state will be <i>null</i>.
     * 
     * @return
    ...
    public final static class SalesOrderHeaderPrElementBuilder {

        private SalesOrder toSalesOrder;
        private String salesOrder = null;

        private SalesOrderHeaderPrElement.SalesOrderHeaderPrElementBuilder toSalesOrder(SalesOrder value) {
            toSalesOrder = value;
            return this;
        }
         ...
         * 
         */
        public SalesOrderHeaderPrElement.SalesOrderHeaderPrElementBuilder salesOrder(final SalesOrder value) {
         ...
         * 
         */
        public SalesOrderHeaderPrElement.SalesOrderHeaderPrElementBuilder salesOrder(final String value) {
            salesOrder = value;
            return this;
        }
