...
public class CustInq {
    ...
    public String toString() {
        return "CustInq{" + "metadata=" + metadata + ", customer=" + customer + ", salesOrganization=" +
                salesOrganization + ", distributionChannel=" + distributionChannel + ", division=" + division +
                ", customerPaymentTerms=" + customerPaymentTerms + ", deliveryIsBlockedForCustomer=" +
                deliveryIsBlockedForCustomer + ", orderIsBlockedForCustomer=" + orderIsBlockedForCustomer +
                ", shippingCondition=" + shippingCondition + ", deletionIndicator=" + deletionIndicator + 
                ", currency=" + currency + ", salesGroup=" + salesGroup + ", SalesOffice=" + SalesOffice + '}';
    }
